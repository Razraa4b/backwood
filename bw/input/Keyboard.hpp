...
namespace bw
{
	enum class KeyCode
	{
        Unknown = -1, // Represents any keycode not present in this enum class
        A = 0,        // The A key
        B,            // The B key
        C,            // The C key
        D,            // The D key
        ...
        LeftSuper,    // The left OS specific key: window (Windows and Linux), apple (macOS), ...
        RightControl, // The right Control key
        RightShift,   // The right Shift key
        RightAlt,     // The right Alt key
        RightSuper,   // The right OS specific key: window (Windows and Linux), apple (macOS), ...
        Menu,         // The Menu key
        LBracket,     // The [ key
        RBracket,     // The ] key
        Semicolon,    // The ; key
    ...
    enum class ScanCode
    {
        Unknown = -1, // Represents any scancode not present in this enum class
        ...
        LeftControl,        // Keyboard Left Control key
        LeftShift,          // Keyboard Left Shift key
        LeftAlt,            // Keyboard Left Alt key
        LeftSuper,          // Keyboard Left System key
        RightControl,       // Keyboard Right Control key
        RightShift,         // Keyboard Right Shift key
        RightAlt,           // Keyboard Right Alt key
        RightSuper,         // Keyboard Right System key
    ...
    {
        Unknown = -1, // Represents any key action not present in this enum class
        Press = 0,
        Release,
        Repeat,
        Count
